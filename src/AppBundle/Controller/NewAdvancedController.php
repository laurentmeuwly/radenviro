...
class NewAdvancedController extends Controller
{    
	...
	/**
	 * Lists all network.
	 * @Route("/netsearch", name="v2-netsearch")
	 * @return Response
	 */
	 ...
	 * @Route("/advanced", name="v2-advanced")
	 ...
	 * @param Sample $sample
	 *
	 * Route("/{id}", name = "v2-toto", options = {"expose" = true})
	 *
	 * @return Response
	 */
    ...
    /**
     * Lists all entities.
     * @Route("/list2", name="v2-datatable_list")
     * @return Response
     */
    ...
    /**
     * @Route("/paginate", name="v2-station_paginate")
     */
